...
public class noise : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxParticles = 100000;
        psf4 = new particleSystemFigure4(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles,particleMaterial);
    }
}
...
public class particleSystemFigure4
{
    ...
    public Material particleMaterial;
    public particleSystemFigure4(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial)
    {
    ...
    public void noiseModule()
    {
        ...
        noiseModule.sizeAmount = 6;

        noiseModule.octaveCount = 4;
        noiseModule.octaveMultiplier = .4f;
        noiseModule.octaveScale = 1.2f;
    }
