...
public class upAndDown : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        createParticleSystem(Vector3.zero, new Vector3(0f, 3f, 0f));
        createParticleSystem(Vector3.zero, new Vector3(0f, -3f, 0f), psf2.particleSystemGameObject);
    }
    void Update()
    {
    ...
    void createParticleSystem(Vector3 origin, Vector3 direction)
    {
        Vector3 particleSystemLocation = new Vector3(origin.x, origin.y, 0);
        Vector3 velocity = direction;
        float lifeTime = 5f;
        float startSpeed = 5f;
        Debug.Log(velocity+", "+startSpeed);
        int maxParticles = 1000;

        psf2 = new particleSystemFigure2(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial);
    }

    void createParticleSystem(Vector3 origin, Vector3 direction, GameObject parentParticleSystem)
    {
        Vector3 particleSystemLocation = new Vector3(origin.x, origin.y, 0);
        ...
        particleSystemFigure2 child = new particleSystemFigure2(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial);
...
public class particleSystemFigure2
{
    ...
    public particleSystemFigure2(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial)
    {
