...
public class ribbons : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxParticles = 1000;
        psf3 = new particleSystemFigureT(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial,ribbonMaterial);
    }
}

public class particleSystemFigureT
{
    ...
    public Material particleMaterial;
    public Material ribbonMaterial;
    public particleSystemFigureT(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial, Material ribbonMaterial)
    {
        ...
        this.ribbonMaterial = ribbonMaterial;
    ...
    public void colorModule()
    {
        ...
        grad.SetKeys(new GradientColorKey[] { new GradientColorKey(Color.white, 0.0f) }, new GradientAlphaKey[] { new GradientAlphaKey(1.0f, 0.0f), new GradientAlphaKey(1f, 2.0f) });
    ...
    public void trailModule()
    {
        ...
        curve.AddKey(0.5f, .75f);
        curve.AddKey(1f, 0f);

        trailsModule.widthOverTrail = new ParticleSystem.MinMaxCurve(1f,curve);
        ...
        r.trailMaterial = ribbonMaterial;
    }
