...
public class colors : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        psf1 = new particleSystemFigure3(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial);
    }
}
...
public class particleSystemFigure3
{
    ...
    public particleSystemFigure3
        
        
        
        
        (Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial)
    {
    ...
    public void colorModule()
    {
        ...
        grad.SetKeys(new GradientColorKey[] { new GradientColorKey(Color.red, 0.0f), new GradientColorKey(Color.green, 0.33f), new GradientColorKey(Color.blue, .66f) }, new GradientAlphaKey[] { new GradientAlphaKey(1.0f, 0.0f), new GradientAlphaKey(0f, 2.0f) });
