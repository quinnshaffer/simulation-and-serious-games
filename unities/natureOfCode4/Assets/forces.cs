...
public class forces : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxParticles = 1000;
        r = new repeller(1f,new Vector3(10f, -3.1f, 0f));
        r = new repeller(-2f, new Vector3(-1.25f, -5.5f, 0f));
...
public class repeller
{
    ...
    public repeller(float strength, Vector3 loc)
    {
        ...
        repelField.gravity = repellerStrength;
        //We set a range for the field
        repelField.endRange = 2.5f * repelField.transform.localScale.x;
        repelField.startRange = .75f * repelField.transform.localScale.x;
    }
}